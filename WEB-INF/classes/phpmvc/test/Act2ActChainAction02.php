<?php
/*
* $Header: /PHPMVC/phpmvc-base/WEB-INF/classes/phpmvc/test/Act2ActChainAction02.php,v 1.4 2006/02/22 06:30:25 who Exp $
* $Revision: 1.4 $
* $Date: 2006/02/22 06:30:25 $
*
* ====================================================================
*
...
* @access public
*/
class Act2ActChainAction02 extends Action {
	...
	*/
	function execute($mapping, $form, &$request, &$response) {
		...
		if($trace) {
			$this->log->trace('Start: Act2ActChainAction02->execute(...)'.
									'['.__LINE__.']');
		}

		// Forward control to the specified success URI
		// <action .../> <forward name ="nextActionPath" .../> </action>
		return $mapping->findForwardConfig('lastActionPath');
