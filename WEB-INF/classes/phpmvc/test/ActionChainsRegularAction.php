<?php
/*
* $Header: /PHPMVC/phpmvc-base/WEB-INF/classes/phpmvc/test/ActionChainsRegularAction.php,v 1.4 2006/02/22 06:32:39 who Exp $
* $Revision: 1.4 $
* $Date: 2006/02/22 06:32:39 $
*
* ====================================================================
*
...
* @public
*/
class ActionChainsRegularAction extends Action {
	...
	*/
	...
	function ActionChainsRegularAction() {
	...
	*/
	function execute($mapping, $form, &$request, &$response) {
		...
		if($trace) {
			$this->log->trace('Start: LogonAction->execute(...)'.
									'['.__LINE__.']');
		}

		// Forward control to the specified success URI
		// <action .../> <forward name ="nextActionPath" .../> </action>
		return $mapping->findForwardConfig('regularActionPath');
